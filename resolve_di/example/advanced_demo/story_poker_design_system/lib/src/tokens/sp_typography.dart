...
/// Font families bundled with the `story_poker_design_system` package.
///
/// The `packages/story_poker_design_system/` prefix is required because the
/// fonts are declared in this package's pubspec, not in the consuming app.
abstract final class SpFonts {
  static const String sans = 'packages/story_poker_design_system/Inter';
  static const String mono = 'packages/story_poker_design_system/JetBrainsMono';
}
