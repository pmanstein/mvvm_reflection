...
#ifndef MVVM_REFLACTION_SWIFT_H
#define MVVM_REFLACTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mvvm_reflaction",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15mvvm_reflaction11AppDelegate")
...
SWIFT_CLASS("_TtC15mvvm_reflaction17MainFlutterWindow")
